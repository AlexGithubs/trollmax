...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: "Step 2 — Script",
    content:
      "Name your video, pick a template chip to get started, then edit the script. Up to 750 characters.",
    placement: "bottom",
    spotlightPadding: 8,
  },
  {
  ...
  },
  {
    ...
    title: "2. Phrases",
    content: "Each phrase becomes a playable button on your soundboard. Edit, remove, or add up to 6 at base rate. All voices use ElevenLabs.",
    placement: "top",
    spotlightPadding: 8,
  },
  {
